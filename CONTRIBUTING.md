...
### How to contribute ?
We will accept contributions from anybody assuming they respect our policies and help improve the platform. here's the different type of contribution we support.
...
A [pull request](https://docs.github.com/en/github/collaborating-with-issues-and-pull-requests/about-pull-requests) is a way to suggest changes in our repository. When we merge those changes, it will kick of a new build and push the new version to docker. :earth_africa:
...
Once your PR is merged, your contributions will be publicly visible on the [Fleet Telemetry github](https://github.com/teslamotors/fleet-telemetry).
